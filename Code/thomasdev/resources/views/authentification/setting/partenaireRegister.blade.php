...
@section('contenu')
    <div class="container">
        <h2 class="text-center" style="text-transform: uppercase">création du compte partenaire</h2>
    ...
    <section class="container mt-5" >
        <form method="POST" action="{{Route('partenaire')}}" enctype="multipart/form-data" class="row g-3 " style="background: #3333; margin-left:40px ">
            @csrf
            <div class="col-md-4">
            ...
            <div class="col-md-6">
                <label for="service" class="form-label">Service offrant du partenaire <strong style="color: red"> *</strong></label>
                <input type="text" class="form-control" id="service" name="service" :value="old('service')" required autofocus autocomplete="service">
            ...
            <div class="col-md-4">
                <label for="document" class="form-label">Partenariat <strong style="color: red"> *</strong></label>
