...
@section('contenu')
    <div class="container">
        <h4 class="text-center" style="text-transform: uppercase">Ajout d'un domaine</h4>
    ...
    <section class="container mt-5" >
        <form method="POST" action="{{Route('domaine')}}" class="row g-3 " style="background: #3333; margin-left:40px ">
            @csrf
            <div class="col-md-6">
                <label for="nom" class="form-label">Nom du domaine <strong style="color: red"> *</strong></label>
