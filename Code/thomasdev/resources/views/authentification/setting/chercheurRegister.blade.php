...
@section('contenu')
    <div class="container">
        <h2 class="text-center" style="text-transform: uppercase">création du compte chercheur</h2>
    ...
    <section class="container mt-5" >
        <form method="POST" action="{{Route('chercheur')}}" enctype="multipart/form-data" class="row g-3 " style="background: #3333; margin-left:40px ">
            @csrf
            <div class="col-md-4">
            ...
            <div class="col-md-6">
                <label for="titre" class="form-label">Titre académique</label>
                <input type="text" class="form-control" id="titre" name="titre" :value="old('titre')" autofocus autocomplete="titre">
                <x-input-error :messages="$errors->get('titre')" class="mt-2" />
            </div>
            <div class="col-md-6">
                <label for="specialite" class="form-label">Spécialité <strong style="color: red"> *</strong></label>
                <input type="text" class="form-control" id="specialite" name="specialite" :value="old('specialite')" required autofocus autocomplete="specialite">
            ...
            <div class="col-md-6">
                ...
                <input type="file"  id="cv" name="cv" required autofocus autocomplete="cv">
