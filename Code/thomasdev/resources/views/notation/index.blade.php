        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent"  >
            <ul class="nav navbar-nav ml-auto " >
                @if( auth('membre')->check())
                    <li class="nav-item" data-bs-toggle="tooltip" data-bs-custom-class="tooltip" data-bs-placement="bottom" data-bs-title="noter les solutions proposées">
                        <a class="nav-link " href="{{Route('solution1')}}">Noter une solution</a>
                    </li>
                    <li class="nav-item" data-bs-toggle="tooltip" data-bs-custom-class="tooltip" data-bs-placement="bottom" data-bs-title="les notes proposées par les différents membres">
                        <a class="nav-link " href="{{Route('acceuil1')}}">Statistiques des notes</a>
                    </li>
                ...
                @elseif (auth()->check())
                    @if (auth()->user()->is_staff || auth()->user()->is_superuser)
                        <li class="nav-item" data-bs-toggle="tooltip" data-bs-custom-class="tooltip" data-bs-placement="bottom" data-bs-title="noter les solutions proposées">
                            <a class="nav-link " href="{{Route('solution')}}">Noter une solution</a>
                        </li>
                    @endif
                    <li class="nav-item" data-bs-toggle="tooltip" data-bs-custom-class="tooltip" data-bs-placement="bottom" data-bs-title="les notes proposées par les différents membres">
                        <a class="nav-link " href="{{Route('acceuil')}}">Statistiques des notes</a>
                    </li>
                    @if (auth()->user()->image)
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
